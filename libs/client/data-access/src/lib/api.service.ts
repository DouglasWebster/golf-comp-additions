...
export class ApiService {
  ...
  updateCompetitor(
    competitorId: string,
    competitorData: IUpdateCompetitor
  ): Observable<ICompetitor> {
    return this.http.patch<ICompetitor>(
  ...
  createOrUpdateCompetitor(
    competitorId: string,
    competitorData: IUpsertCompetitor
  ): Observable<ICompetitor> {
    return this.http.put<ICompetitor>(
      `/api/competitors/${competitorId}`,
      competitorData
    );
  }
